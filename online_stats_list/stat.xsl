...
<xsl:template match="/">
	...
	<head>
		...
		<style type="text/css" media="screen">@import url(stat.css);</style>
		<!--[if lt IE 7.]>
...
<xsl:template match="status" priority="1">
	<table width="100%" border="0" cellspacing="1" cellpadding="3" class="stats_table">
		<tr class="stats_head"><th class="stats_th" colspan="4">Server Status for <xsl:value-of select="servername"/></th></tr>
		<tr class="stats_head"><th class="stats_th" colspan="4"><xsl:value-of select="platform"/></th></tr>
		<tr>
			<th class="stats_th">Uptime: </th><td class="stats_td"><xsl:value-of select="uptime"/></td>
			<th class="stats_th">Online Players: </th><td class="stats_td"><xsl:value-of select="oplayers"/></td>
		</tr>
		<tr>
			<th class="stats_th">Alliance Online: </th><td class="stats_td"><xsl:value-of select="alliance"/></td>
			<th class="stats_th">Connection Peak: </th><td class="stats_td"><xsl:value-of select="peakcount"/></td>
		</tr>
		<tr>
			<th class="stats_th">Horde Online: </th><td class="stats_td"><xsl:value-of select="horde"/></td>
		</tr>
	</table>
...
<xsl:template match="gms" priority="3">
	<table width="100%" border="0" cellspacing="1" cellpadding="2" class="stats_table">
		<tr class="stats_head">
			<th class="stats_th" colspan="8">Online GMs</th>
		</tr>
		<tr>
			<th class="stats_th">Name</th>
			<th class="stats_th"><center>Race</center></th>
			<th class="stats_th"><center>Class</center></th>
			<th class="stats_th"><center>Level</center></th>
			<th class="stats_th"><center>Permissions</center></th>
		</tr>

		<xsl:for-each select="gmplr">
		<xsl:sort select="level" data-type="number"/>
		<tr>
			<td class="stats_td"><xsl:value-of select="name"/></td>
...
<xsl:template match="sessions" priority="2">
	<table width="100%" border="0" cellspacing="1" cellpadding="2" class="stats_table">
		<tr class="stats_head">
			<th class="stats_th" colspan="9">Online Players</th>
		</tr>
		<tr>
			<th class="stats_th">Name</th>
			<th class="stats_th"><center>Race</center></th>
			<th class="stats_th"><center>Class</center></th>
			<th class="stats_th"><center>Rank</center></th>
			<th class="stats_th"><center>Level</center></th>
			<th class="stats_th">Map</th>
			<th class="stats_th">Zone</th>
		</tr>
		...
		<tr>
			...
			<td class="stats_td">
				<xsl:choose>
					<xsl:when test="areaid = 0"> </xsl:when>
